...
function createCumParams(cont, cumType) {
    ...
    const cum_bitmex_m_com_ast = createParam('cum_bitmex_M_com/ast:', `cum_bitmex_m_com_ast-${cumType}`)
    ...
    function updateCumValues(p) {
        ...
        if (allSettings.leftIsBtm) {
            ...
            $(`#cum_bitmex_m_com_ast-${cumType}`).hide()
        }
